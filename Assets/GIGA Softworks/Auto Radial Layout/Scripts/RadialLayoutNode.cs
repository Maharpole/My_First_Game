...
namespace GIGA.AutoRadialLayout
{
    ...
    public class RadialLayoutNode : MonoBehaviour
    {
            ...
            else
            {
                ...
                switch (this.Layout.nodesDistribution)
                {
                    case RadialLayout.NodesDistribution.Concentric:
                        ...
                        positionOffset = bisector * (this.Layout.circleRadius * (this.depth + 1) * this.Layout.GetNodesRadiusMultiplier(this.depth) * this.Layout.Canvas.transform.localScale.x + this.GetInheritedDistanceOffset()  + this.distanceOffset * this.Layout.Canvas.transform.localScale.x);
        ...
        private float GetInheritedDistanceOffset()
        {
            ...
            return offset * this.Layout.Canvas.transform.localScale.x;
        }
